...
export interface InventoryItem { id: ID; name: string; sku: string; costPrice: number; sellingPrice: number; stock: number; }
export interface AppState { business: Business; branches: Branch[]; executives: Executive[]; sales: Sale[]; inventory: InventoryItem[]; }
